		...
		// skel
			skel: {
				...
				breakpoints: {
					...
					'wide': { range: '-1920', href: 'css/lib/style-wide.css', containers: 1360 },
					'normal': { range: '-1680', href: 'css/lib/style-normal.css', containers: 1200 },
					'narrow': { range: '-1280', href: 'css/lib/style-narrow.css', containers: 960 },
					'narrower': { range: '-1000', href: 'css/lib/style-narrower.css', containers: '95%', lockViewport: true },
					'mobile': { range: '-640', href: 'css/lib/style-mobile.css', grid: { gutters: 20 } },
